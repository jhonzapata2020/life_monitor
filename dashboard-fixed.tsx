...
export default function Dashboard() {
  ...
  // Valores iniciales estáticos para evitar diferencias de hidratación
  ...
  // Simulate changing data - solo se ejecuta en el cliente
  useEffect(() => {
    // Retrasar la actualización para asegurar que la hidratación ya ocurrió
  ...
  return (
    ...
    >
      {/* Background particle effect - ahora usando el componente separado */}
      <ParticleEffect className="absolute inset-0 w-full h-full opacity-30" />
      ...
      <div className="container mx-auto p-4 relative z-10">
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-12 lg:col-span-3">
            <div className="grid gap-6">
              {/* System time - ahora usando el componente separado */}
              <SystemTime />
