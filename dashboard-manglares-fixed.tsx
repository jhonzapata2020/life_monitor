              ...
              <Card className="bg-slate-900/50 border-slate-700/50 backdrop-blur-sm overflow-hidden">
                <CardContent className="p-0">
                  <div className="border-b border-slate-700/50">
                    <div className="flex">
                      <TabButton2 active={true} label="Deforestación" />
                      <TabButton2 active={false} label="Biodiversidad" />
                      <TabButton2 active={false} label="Erosión Costera" />
                      <TabButton2 active={false} label="Captura de CO2" />
                    </div>
                  </div>
                  ...
                  <div className="p-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        <h3 className="text-sm font-medium text-slate-200 mb-4">Alertas de Deforestación</h3>
                        <div className="space-y-3">
                          <DeforestationAlertItem2
                            severity="high"
                            location="Norte del Golfo de Urabá"
                            date="2025-03-12"
                            area={5.2}
                      ...
                      <div>
                        <h3 className="text-sm font-medium text-slate-200 mb-4">Tendencia de Deforestación</h3>
                        <div className="bg-slate-800/30 rounded-lg border border-slate-700/50 p-4 h-[300px] relative">
                          <DeforestationTrendChart2 />
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        <FileBarChart className="text-green-500 mr-2 h-4 w-4" />
                        <span className="text-sm text-slate-400">Reporte Semanal</span>
                      </div>
                      <Switch />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        <AlertCircle className="text-green-500 mr-2 h-4 w-4" />
                        <span className="text-sm text-slate-400">Alertas por Email</span>
                      </div>
                      <Switch />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        <Activity className="text-green-500 mr-2 h-4 w-4" />
                        <span className="text-sm text-slate-400">Resumen Mensual</span>
                      </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        <RefreshCw className="text-green-500 mr-2 h-4 w-4" />
                        <span className="text-sm text-slate-400">Verificación de Datos</span>
                      </div>
                      <Switch />
                    </div>
                  </div>
...
function TabButton2({ label, active }: { label: string; active: boolean }) {
  return (
    <Button
      variant="ghost"
      className={`flex-1 justify-center rounded-none px-4 py-3 ${
        active ? "bg-slate-800/70 text-green-400" : "text-slate-400 hover:text-slate-100"
      }`}
    >
      {label}
    </Button>
...
// Deforestation alert item component
function DeforestationAlertItem2({
  severity,
  location,
  date,
  area,
  ...
  return (
    <div className="flex items-start space-x-3">
      <div className={`mt-0.5 p-1 rounded-full ${getSeverityColor()}`}>
        <AlertCircle className="h-3 w-3" />
      </div>
      <div>
        <div className="flex items-center">
          <div className="text-sm font-medium text-slate-200">{location}</div>
          <div className="ml-2 text-xs text-slate-500">{date}</div>
        </div>
...
// Deforestation trend chart component (placeholder)
function DeforestationTrendChart2() {
  return (
    <div className="absolute inset-0 flex items-center justify-center text-slate-400">
      Gráfico de Tendencia de Deforestación (Placeholder)
    </div>
  )
}
  ...
  return (
    <div className="bg-slate-800/50 rounded-lg border border-slate-700/50 p-4">
      ...
      <div className="h-2 bg-slate-700 rounded-full overflow-hidden mb-2">
        <div className={`h-full bg-${statusColor}-500`} style={{ width: `${progress}%` }}></div>
      </div>
