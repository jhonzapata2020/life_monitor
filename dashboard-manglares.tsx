...
export default function DashboardManglares() {
  ...
  // Elimina también la referencia al canvas y el useEffect relacionado con las partículas
  ...
  // Eliminar todo el efecto de partículas
  // useEffect(() => {
  ...
  //     update() {
  //       // Asegurarse de que canvas no sea null antes de acceder a sus propiedades
  //       if (!canvas) return
  ...
  //     draw() {
  //       // Asegurarse de que ctx no sea null antes de dibujar
  //       if (!ctx) return
  ...
  //   function animate() {
  //     // Verificar que canvas y ctx no sean null
